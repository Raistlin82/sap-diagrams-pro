...
| JSON entity | Atomic design level |
|---|---|
| `metadata` (palette / fonts) | atoms |
| `nodes[]` (single component) | molecules |
| `groups[]` (cluster of components) | organisms |
| `edges[]` (line + label) | molecules |
